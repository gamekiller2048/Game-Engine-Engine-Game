...
#ifndef mcl_CSTRING_VIEW_HPP
#define mcl_CSTRING_VIEW_HPP
...
namespace mcl {
    ...
    inline namespace literals {
        inline namespace string_view_literals {
            ...
            /*******************************************************************************************************************/
            [[nodiscard]] constexpr mcl::cstring_view operator""_csv(const char* str, const std::size_t len) noexcept {
                return { mcl::cstring_view::null_terminated, str, len };
            }
#if defined(__cpp_char8_t)
            [[nodiscard]] constexpr mcl::u8cstring_view operator""_csv(const char8_t* str, const std::size_t len) noexcept {
                return { mcl::u8cstring_view::null_terminated, str, len };
            }
#endif
            [[nodiscard]] constexpr mcl::u16cstring_view operator""_csv(const char16_t* str, const std::size_t len) noexcept {
                return { mcl::u16cstring_view::null_terminated, str, len };
            }
            [[nodiscard]] constexpr mcl::u32cstring_view operator""_csv(const char32_t* str, const std::size_t len) noexcept {
                return { mcl::u32cstring_view::null_terminated, str, len };
            }
            [[nodiscard]] constexpr mcl::wcstring_view operator""_csv(const wchar_t* str, const std::size_t len) noexcept {
                return { mcl::wcstring_view::null_terminated, str, len };
            }
...
namespace std {
    ...
    template <>
    struct hash<mcl::cstring_view> {
        [[nodiscard]] std::size_t operator()(const mcl::cstring_view csv) {
            return std::hash<typename mcl::cstring_view::string_view_type>{}(csv);
        }
    };
#if defined(__cpp_char8_t)
    template <>
    struct hash<mcl::u8cstring_view> {
        [[nodiscard]] std::size_t operator()(const mcl::u8cstring_view csv) {
            return std::hash<typename mcl::u8cstring_view::string_view_type>{}(csv);
        }
    };
#endif
    template <>
    struct hash<mcl::u16cstring_view> {
        [[nodiscard]] std::size_t operator()(const mcl::u16cstring_view csv) {
            return std::hash<typename mcl::u16cstring_view::string_view_type>{}(csv);
        }
    };
    template <>
    struct hash<mcl::u32cstring_view> {
        [[nodiscard]] std::size_t operator()(const mcl::u32cstring_view csv) {
            return std::hash<typename mcl::u32cstring_view::string_view_type>{}(csv);
        }
    };
    template <>
    struct hash<mcl::wcstring_view> {
        [[nodiscard]] std::size_t operator()(const mcl::wcstring_view csv) {
            return std::hash<typename mcl::wcstring_view::string_view_type>{}(csv);
        }
    };
...
inline constexpr bool std::ranges::enable_borrowed_range<mcl::basic_cstring_view<charT, traits>> = true;
template <typename charT, typename traits>
inline constexpr bool std::ranges::enable_view<mcl::basic_cstring_view<charT, traits>> = true;
#endif
...
template <typename charT, typename traits>
struct std::formatter<mcl::basic_cstring_view<charT, traits>> : std::formatter<std::basic_string_view<charT, traits>> {
    auto format(const mcl::basic_cstring_view<charT, traits>& csv, std::format_context& ctx) const {
        return std::formatter<std::basic_string_view<charT, traits>>::format(static_cast<std::basic_string_view<charT, traits>>(csv), ctx);
    }
};
#endif

#endif  // mcl_CSTRING_VIEW_HPP