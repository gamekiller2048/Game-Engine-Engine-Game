...
namespace mgl
{
    ...
    BasicMaterial::BasicMaterial(RenderContext* context, const BasicShaderVariant& shaderVariant) :
        Material(context)
    {
    ...
    StandardMaterial::StandardMaterial(RenderContext* context, const StandardShaderVariant& shaderVariant) :
